...
enum ImageType : int8_t {
  ...
  ImageType_Decoded = 2,
  ImageType_Filter = 3,
  ImageType_Generator = 4,
  ImageType_Mipmap = 5,
  ImageType_Orient = 6,
  ImageType_Picture = 7,
  ImageType_Rasterized = 8,
  ImageType_RGBAAA = 9,
  ImageType_Texture = 10,
  ImageType_Subset = 11,
  ImageType_MIN = ImageType_Buffer,
  ImageType_MAX = ImageType_Subset
};

inline const ImageType (&EnumValuesImageType())[12] {
...
inline const char *EnumNameImageType(ImageType e) {
  if (::flatbuffers::IsOutRange(e, ImageType_Buffer, ImageType_Subset)) return "";
  const size_t index = static_cast<size_t>(e);
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4) ImageAttribute FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  ...
  ImageAttribute(tgfx::fbs::ImageType _image_type, int32_t _image_width, int32_t _image_height, bool _image_alpha_only, bool _image_mipmap, bool _image_fully_decode, bool _image_texture_backed)
      : image_type_(::flatbuffers::EndianScalar(static_cast<int8_t>(_image_type))),
        padding0__(0),
        padding1__(0),
  ...
  tgfx::fbs::ImageType image_type() const {
    return static_cast<tgfx::fbs::ImageType>(::flatbuffers::EndianScalar(image_type_));
  }
...
struct LayerCommonAttributeBuilder {
  ...
  void add_address(uint64_t address) {
    fbb_.AddElement<uint64_t>(LayerCommonAttribute::VT_ADDRESS, address, 0);
  }
...
struct TreeNodeBuilder {
  ...
  void add_address(uint64_t address) {
    fbb_.AddElement<uint64_t>(TreeNode::VT_ADDRESS, address, 0);
  }
