// Shared blur-source vertex template: position transform plus one affine texture
// coordinate, with the coord output preceding the position write. Used by
// GaussianBlur1DShader and GlassUDFTentBlurShader.
#version 450
