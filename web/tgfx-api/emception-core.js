...
import FileSystem from "./emception-dist/FileSystem.mjs";
import LlvmBoxProcess from "./emception-dist/LlvmBoxProcess.mjs";
import BinaryenBoxProcess from "./emception-dist/BinaryenBoxProcess.mjs";
...
export default class EmceptionCore {
    ...
    async loadCompilerWasm() {
        ...
        // 加载LLVM编译器WASM
        const llvmWasmResponse = await fetch('./emception-dist/llvm/llvm-box.wasm');
        ...
        // 加载Binaryen编译器WASM
        const binaryenWasmResponse = await fetch('./emception-dist/binaryen/binaryen-box.wasm');
